			...
			<section class="content">
				...
				<div class="col-lg-4 col-xs-6">
						...
						<div class="small-box bg-aqua">
							...
							<a href="<%=basePath%>backstage/reservation/show.html" class="small-box-footer">查看详情 <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
					<div class="col-lg-4 col-xs-6"> 
							<!-- small box -->
