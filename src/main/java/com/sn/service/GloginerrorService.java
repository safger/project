...
public interface  GloginerrorService{ 
	...
	public PagedResult<Gloginerror> findByPage(Gloginerror record,Integer indexPage,Integer pageSize,String orderBy );
	
	public PagedResult<Gloginerror> findByPageCustom(Gloginerror record, Integer indexPage,Integer pageSize,String orderBy);
